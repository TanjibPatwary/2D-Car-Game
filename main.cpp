...
///Hills
    glColor3f(0.4, 0.4, 0.2);
    DrawHalfCircle(15, 80, 9.25, 6); //1
    glColor3f(0.4, 0.4, 0.2);
    DrawHalfCircle(35,80,9.25,6);//2
    glColor3f(0.2, 0.2, .2);
    DrawHalfCircle(55,80,10.5,6);//3
    glColor3f(0.2, 0.2, .2);
    DrawHalfCircle(75, 80, 10.5, 6);
...
void timer(int){
    glutPostRedisplay();
    glutTimerFunc(10000/FPS,timer,0);
}
